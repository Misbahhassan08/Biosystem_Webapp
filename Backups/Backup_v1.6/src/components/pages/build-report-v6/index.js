      ...
      <Container>
        <Row>
          <Col className="px-4">
            <Card className=" p-0 border-0 ">
              <Card.Body className="text-center p-0">
                <Link to={process.env.PUBLIC_URL + "/build-report-v6/grid"}>
                  <img
                    src={ImageTwo}
                    alt="Data_Grid"
          ...
          <Col className="px-4">
            <Card className=" p-0 border-0 ">
              <Card.Body className="text-center p-0">
                <Link to={process.env.PUBLIC_URL + "/build-report-v6/graph"}>
                  <img
                    src={GraphImgae}
                    alt="Data_Graph"
                    className="img-fluid report-image"
