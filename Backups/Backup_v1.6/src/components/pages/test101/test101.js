...
const rowsInput={
    Data_Point:'0', Sample_Num:'1', Time_Stamp:'2023-04-06 08:07:49.659752', Time_Per:'20.75', Temp:'40', Gain:'30', Int_Time:'320',Allowable_Dev:'150',
    Raw_Used_Vio:'342,342,342,342,342,342', Raw_Values_Vio_450nm:'342,342,342,342,342,342', Raw_Selected_Vio_450nm:'342,342,342,342,342,342', Raw_Avg_Vio_450nm:'342', Raw_StdDev_Vio_450nm:'342,342,342,342,342,342', Call_Used_Vio:'347.33,347.33,347.33,347.33,347.33,347.33', Call_Values_Vio_450nm:'', Cal_Selected_Vio_450nm:'', Cal_Avg_Vio_450nm:'', Cal_StdDev_Vio_450nm:'',
    Raw_Used_Blu:'342,342,342,342,342,342', Raw_Values_Blu_500nm:'342,342,342,342,342,342', Raw_Selected_Blu_500nm:'342,342,342,342,342,342', Raw_Avg_Blu_500nm:'456', Raw_StdDev_Blu_500nm:'', Call_Used_Blu:'', Call_Values_Blu_500nm:'', Cal_Selected_Blu_500nm:'347.33,347.33,347.33,347.33,347.33,347.33', Cal_Avg_Blu_500nm:'', Cal_StdDev_Blu_500nm:'',
    Raw_Used_Grn:'342,342,342,342,342,342', Raw_Values_Grn_550nm:'342,342,342,342,342,342', Raw_Selected_Grn_550nm :'342,342,342,342,342,342', Raw_Avg_Grn_550nm:'456', Raw_StdDev_Grn_550nm:'', Call_Used_Grn:'', Call_Values_Grn_550nm:'', Cal_Selected_Grn_550nm:'347.33,347.33,347.33,347.33,347.33,347.33', Cal_Avg_Grn_550nm:'', Cal_StdDev_Grn_550nm:'',
} 
...
const rowsInput={
    Data_Point:data['Data_Point'][0], Sample_Num:data['Sample_Num'][0], Time_Stamp:data['Time_Stamp'][0], Time_Per:data['Time_Per'][0], Temp:data['Temp'][0], Gain:data['Gain'][0], Int_Time:data['Int_Time'][0],Allowable_Dev:data['Allowable_Dev'][0],
    Raw_Used_Vio:data['Raw_Used_Vio'][0], Raw_Values_Vio_450nm:data['Raw_Values_Vio_450nm'][0], Raw_Selected_Vio_450nm:data['Raw_Selected_Vio_450nm'][0], Raw_Avg_Vio_450nm:data['Raw_Avg_Vio_450nm'][0], Raw_StdDev_Vio_450nm:data['Raw_StdDev_Vio_450nm'][0], Call_Used_Vio:data['Call_Used_Vio'][0], Call_Values_Vio_450nm:data['Call_Values_Vio_450nm'][0], Cal_Selected_Vio_450nm:data['Cal_Selected_Vio_450nm'][0], Cal_Avg_Vio_450nm:data['Cal_Avg_Vio_450nm'][0], Cal_StdDev_Vio_450nm:data['Cal_StdDev_Vio_450nm'],
    Raw_Used_Blu:data['Raw_Used_Blu'][0], Raw_Values_Blu_500nm:data['Raw_Values_Blu_500nm'][0], Raw_Selected_Blu_500nm:data['Raw_Selected_Blu_500nm'][0], Raw_Avg_Blu_500nm:data['Raw_Selected_Blu_500nm'][0], Raw_StdDev_Blu_500nm:data['Raw_StdDev_Blu_500nm'][0], Call_Used_Blu:data['Call_Used_Blu'][0], Call_Values_Blu_500nm:data['Call_Values_Blu_500nm'][0], Cal_Selected_Blu_500nm:data['Cal_Selected_Blu_500nm'][0], Cal_Avg_Blu_500nm:data['Cal_Avg_Blu_500nm'][0], Cal_StdDev_Blu_500nm:data['Cal_StdDev_Blu_500nm'][0],
    Raw_Used_Grn:data['Raw_Used_Grn'][0], Raw_Values_Grn_550nm:data['Raw_Values_Grn_550nm'][0], Raw_Selected_Grn_550nm :data['Raw_Selected_Grn_550nm'][0], Raw_Avg_Grn_550nm:data['Raw_Avg_Grn_550nm'][0], Raw_StdDev_Grn_550nm:data['Raw_StdDev_Grn_550nm'][0], Call_Used_Grn:data['Call_Used_Grn'], Call_Values_Grn_550nm:data['Call_Values_Grn_550nm'][0], Cal_Selected_Grn_550nm:data['Cal_Selected_Grn_550nm'], Cal_Avg_Grn_550nm:data['Cal_Avg_Grn_550nm'][0], Cal_StdDev_Grn_550nm:data['Cal_StdDev_Grn_550nm'][0],
} 
...
setRowsData([...TableData, rowsInput])
  ...
  useEffect(() => {
      ...
      setInterval(() => {
        ...
        client.publish(topic_bulkData_request, JSON.stringify(obj), { qos: 0, retain: false })
      ...
      //  console.log('54', client.subscribe('/testtopic/sensor', { qos: 0 }))
        ...
        client.on('message', (topic, message, packet) => {
            ...
            else if (topic == topic_led_sensor)
            {
                ...
                if(json_obj.Sensor == 0){{set_led1_sensor_value(Number(json_obj.Value.toString()))}}//{set_led1_sensor_value(Number(message["value"]))}
                else if(json_obj.Sensor == 1){set_led2_sensor_value(Number(json_obj.Value.toString()))}
                else if(json_obj.Sensor == 2){set_led3_sensor_value(Number(json_obj.Value.toString()))}
                else if(json_obj.Sensor == 3){set_led4_sensor_value(Number(json_obj.Value.toString()))}
                else if(json_obj.Sensor == 4){set_led5_sensor_value(Number(json_obj.Value.toString()))}
  ...
  const onBtnOnClicked = () => {
    let obj = {"id":1,"Motor":true,"speed":100}
      client.publish(topic_motor_speed, JSON.stringify(obj), { qos: 0, retain: false })
  }
 ...
 const onSendLedBrigtness1 = () => {
    ...
    client.publish(topic_led_brightness, JSON.stringify(obj), { qos: 0, retain: false })
    //client.publish('')
 }
...
const onSendStepperMotor = () => {
    ...
    client.publish(topic_stepper_count, JSON.stringify(obj), { qos: 0, retain: false })
}

const onSend_Open_LinearStepperMotor = () => {
    let obj  = {"status":"open","count" : Number(linear_var_stepper_counts)}
    console.log("Value of linear Stepper steps are : ", linear_var_stepper_counts)
    client.publish(topic_linear_stepper_count, JSON.stringify(obj), { qos: 0, retain: false })
}
