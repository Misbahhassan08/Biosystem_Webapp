...
function RackCompleted(){
    ...
    return (
        ...
        <h2 className="main-title text-center mb-5 text-light-blue">Rack Status/Rack1/Completed</h2>
        ...
        <Row className="home-card mx-auto">
            <Col>
                <Card onClick={handleShow}>
                    ...
                    <li>Complete
                    <Button variant="dark1 notification-btn">4</Button></li>
                    </ul>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><Form.Control type="text" placeholder="" /></td>
              ...
              <p class="status">Status:<span> OK</span></p>
                  </form>
      </Card>
