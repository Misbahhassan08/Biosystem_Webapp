...
function Table(props) {
  ...
  const formatData = {
    A: props.setTableData?.table?.A || initialData.A,
    A_pre: props.setTableData?.table.A_pre || initialData["A-pre"],
    B: props.setTableData?.table?.B || initialData.B,
    B_pre: props.setTableData?.table.B_pre || initialData["B-pre"],
    C: props.setTableData?.table?.C || initialData.C,
    C_pre: props.setTableData?.table.C_pre || initialData["C-pre"],
  };
