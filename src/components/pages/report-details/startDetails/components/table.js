    ...
    >
      <table className="sample-details" style={{ width: "100%" }}>
        ...
        <tr className="color_yel sampleTableDataRows">
          ...
          <td><input id="A0" type="text" className="form-control" /></td>
          <td><input id="A1" type="text" className="form-control" /></td>
          <td><input id="A2" type="text" className="form-control" /></td>
          <td><input id="A3" type="text" className="form-control" /></td>
          <td><input id="A4" type="text" className="form-control" /></td>
          <td><input id="A5" type="text" className="form-control" /></td>
          <td><input id="A6" type="text" className="form-control" /></td>
          <td><input id="A7" type="text" className="form-control" /></td>
          <td><input id="A8" type="text" className="form-control" /></td>
          <td><input id="A9" type="text" className="form-control" /></td>
        </tr>
        {/* row 2 */}
        <tr className="color_yel sampleTableDataRows">
          <td>
