    ...
    <>
      ...
      <Accordion.Item eventKey="0">
        ...
        <ul className="py-0 px-3 mt-3">
          <li className="mb-2"> Daily system QC: Temp, CO2 log
          </li>
...
<Row className="mt-4"><Col><div className="calendar-container">
<Calendar onChange={setDate} value={date}/>
</div></Col></Row>
<Link to={`${process.env.PUBLIC_URL}/reports/qc-status`} className="w-25 report-info-btn mx-auto px-4 py-2 rounded-pill d-flex justify-content-center align-items-center mt-4">Current QC Status</Link>
