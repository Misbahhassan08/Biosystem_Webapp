...
function WaveLengthGraphData(props) {
  ...
  function handleExportImage() {
    const graphContainer = document.getElementById("graph-container"+props.dataType +wave);
    domtoimage
  ...
  return (
    <div >
      ...
      <Button type="submit" className="mx-2 menu-btn menu-btn1"><CSVLink {...csvReport}>Export Data to CSV</CSVLink></Button>
      <Button
        type="submit"
